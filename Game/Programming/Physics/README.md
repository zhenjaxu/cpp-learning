...
本项目是一个基于 SDL2 的太空射击小游戏（TravelInSpace），用于学习 C++ 游戏编程中的向量数学、基础物理运动、输入组件、圆形碰撞检测以及简单的游戏对象交互。玩家通过方向键旋转并推进飞船，按下空格发射激光击毁随机生成的小行星。

![TravelInSpace 运行截图1](image/README/1781947476588.png)

![TravelInSpace 运行截图2](image/README/1781947619416.png)

### ✨️特性亮点

- 自定义 Vector2 / Vector3 数学库，支持加减、点积、叉积、归一化等运算
- MoveComponent 组件封装基础位移与转向逻辑
- InputComponent 继承 MoveComponent，实现键盘驱动运动
- CircleComponent 圆形碰撞组件与全局 Intersect 碰撞检测
- 激光射击机制与按键冷却系统
- 随机生成的小行星与对象生命周期管理
